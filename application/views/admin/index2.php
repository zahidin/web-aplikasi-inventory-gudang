    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url()?>pages/layout/top-nav.html"><i class="fa fa-circle-o"></i> Top Navigation</a></li>
            <li><a href="<?php echo base_url()?>pages/layout/boxed.html"><i class="fa fa-circle-o"></i> Boxed</a></li>
            <li><a href="<?php echo base_url()?>pages/layout/fixed.html"><i class="fa fa-circle-o"></i> Fixed</a></li>
            <li><a href="<?php echo base_url()?>pages/layout/collapsed-sidebar.html"><i class="fa fa-circle-o"></i> Collapsed Sidebar</a></li>
          </ul>
        </li>
        <li>
                ...
                <div class="box-body">
                  ...
                  <div class="direct-chat-contacts">
                    <ul class="contacts-list">
                      <li>
                        <a href="#">
                          <img class="contacts-list-img" src="<?php echo base_url()?>dist/img/user1-128x128.jpg" alt="User Image">
                      ...
                      <li>
                        <a href="#">
                          <img class="contacts-list-img" src="<?php echo base_url()?>dist/img/user7-128x128.jpg" alt="User Image">
                      ...
                      <li>
                        <a href="#">
                          <img class="contacts-list-img" src="<?php echo base_url()?>dist/img/user3-128x128.jpg" alt="User Image">
                      ...
                      <li>
                        <a href="#">
                          <img class="contacts-list-img" src="<?php echo base_url()?>dist/img/user5-128x128.jpg" alt="User Image">
                      ...
                      <li>
                        <a href="#">
                          <img class="contacts-list-img" src="<?php echo base_url()?>dist/img/user6-128x128.jpg" alt="User Image">
                      ...
                      <li>
                        <a href="#">
                          <img class="contacts-list-img" src="<?php echo base_url()?>dist/img/user8-128x128.jpg" alt="User Image">
            ...
            <div class="box-body">
              <div class="table-responsive">
                <table class="table no-margin">
                  ...
                  <tbody>
                  <tr>
                    <td><a href="<?php echo base_url()?>pages/examples/invoice.html">OR9842</a></td>
                  ...
                  <tr>
                    <td><a href="<?php echo base_url()?>pages/examples/invoice.html">OR1848</a></td>
                  ...
                  <tr>
                    <td><a href="<?php echo base_url()?>pages/examples/invoice.html">OR7429</a></td>
                    <td>iPhone 6 Plus</td>
              ...
              <ul class="products-list product-list-in-box">
                <li class="item">
                  <div class="product-img">
                    <img src="<?php echo base_url()?>dist/img/default-50x50.gif" alt="Product Image">
                  </div>
